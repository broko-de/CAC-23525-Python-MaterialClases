...
Bienvenido/a al repositorio de la comisión **#23525**. Aquí mantendremos actualizado todo el material que vayamos viendo en clases como ser:
- Presentaciones
- Códigos de ejemplos
- Libros
- Link compartidos
...
git clone https://github.com/broko-de/CAC-23525-Python-MaterialClases
```
