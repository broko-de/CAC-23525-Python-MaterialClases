...
--CONSULTAS
--Peliculas contienen texto 'el'
SELECT title,release_date
FROM movies
WHERE title LIKE '%el%';

--Peliculas que se estrenaron despues del 2000
SELECT title, director
FROM movies
WHERE YEAR(release_date) > 2000;

--Peliculas que se estrenaron antes del 1990 o despues del 2014
SELECT title, director, YEAR(release_date)
FROM movies
